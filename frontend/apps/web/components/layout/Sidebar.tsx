          ...
          {links.map((link) => {
            ...
            return (
              <Link
                ...
                href={link.href}
                className={cn(
                  'flex items-center justify-between px-3.5 py-2.5 min-h-[44px] rounded-xl text-sm font-medium transition-all group',
                  isActive
              ...
              >
                  ...
                  <Icon
                    className={cn(
                      ...
                      isActive
                        ...
                        : 'text-foreground-secondary group-hover:text-[#472393] dark:group-hover:text-foreground'
                    )}
                  />
                ...
                {link.badge && (
                  <Badge variant="outline" className="text-xs py-0 px-2 shrink-0 ml-1.5">
                    {link.badge}
                  </Badge>
                )}
      ...
      <div className="pt-3.5 border-t border-[rgba(15,23,42,0.07)] dark:border-border space-y-2 mt-auto select-none cursor-default">
        <div className="flex items-center justify-between p-2.5 rounded-xl bg-surface-highlight/50 dark:bg-surface-elevated border border-border/60">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="size-7.5 rounded-lg bg-surface-elevated text-foreground-secondary dark:bg-surface-highlight dark:text-foreground-secondary flex items-center justify-center font-bold text-xs shrink-0 border border-border shadow-2xs">
        ...
        <div className="px-2 py-1.5 rounded-lg bg-surface-highlight/30 border border-border/40 text-xs text-foreground-secondary flex items-center gap-1.5">
          <Sparkles className="size-3.5 text-foreground-secondary shrink-0" />
