    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="space-y-0.5">
          <div className="flex items-center gap-1.5 text-xs text-foreground-secondary font-semibold uppercase tracking-wider">
            <Sparkles className="size-3.5 text-foreground" />
            <span>Alternative Credit Evaluation</span>
            {assessment.modelName && (
              <span className="font-mono text-xs text-foreground-secondary lowercase">
      ...
      {isInsufficient ? (
        <div className="space-y-2 py-1">
          <div className="flex items-baseline gap-3">
            ...
            <span className="text-base sm:text-lg text-foreground-secondary font-medium">
              No Score Generated
            </span>
          </div>
        ...
        <div className="flex items-baseline gap-3">
          ...
          <span className="text-2xl text-foreground-secondary font-mono font-medium">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4 border-t border-border">
        <div>
          <span className="text-xs sm:text-sm text-foreground-secondary block">
        ...
        <div>
          <span className="text-xs sm:text-sm text-foreground-secondary block flex items-center gap-1">
