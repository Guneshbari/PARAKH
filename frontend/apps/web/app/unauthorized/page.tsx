    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background text-foreground p-4">
      <div className="w-full max-w-md space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-foreground-secondary leading-relaxed max-w-sm mx-auto">
        ...
        {user && (() => {
          ...
          return (
            <div className="p-4 rounded-xl bg-surface-elevated border border-border text-left space-y-1.5">
              <span className="text-xs font-mono uppercase text-foreground-secondary block">
              ...
              <span className="text-xs sm:text-sm text-foreground-secondary block">{user.email}</span>
            </div>
          );
        })()}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 pt-2">
          {user && (() => {
            ...
            return (
              ...
              >
                <Button className="w-full text-xs sm:text-sm font-semibold gap-1.5 h-9">
          ...
          <Link
            ...
            className="w-full sm:w-auto"
          >
            <Button variant="outline" className="w-full text-xs sm:text-sm font-semibold gap-1.5 h-9">
        ...
        <div className="pt-4 border-t border-border flex items-center justify-center gap-4">
          <Link href="/" className="text-xs sm:text-sm text-foreground-secondary hover:text-foreground flex items-center gap-1.5 font-medium">
            <Home className="size-3.5" /> Home
          </Link>
          {user && (
            <button
              onClick={logout}
              className="text-xs sm:text-sm text-destructive hover:underline underline-offset-4 cursor-pointer font-medium"
            >
              Sign Out Session
            </button>
          )}
