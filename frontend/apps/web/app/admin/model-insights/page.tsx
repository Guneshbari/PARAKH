  ...
  return (
    <PageTransition className="space-y-6 sm:space-y-8 w-full pb-16">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="p-4 rounded-2xl bg-[#0A162E] border border-white/[0.06] space-y-1">
          ...
          <span className="text-[10px] text-teal-300 block">Calibrated Ridge Blend</span>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#0A162E] border border-white/[0.06] space-y-1">
          ...
          <span className="text-[10px] text-muted-foreground block">Anonymized Inflow Records</span>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#0A162E] border border-white/[0.06] space-y-1">
          ...
          <span className="text-[10px] text-teal-300 block">Active Production Baseline</span>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#0A162E] border border-white/[0.06] space-y-1">
          ...
          <span className="text-[10px] text-teal-300 block">Zero Protected Disparities</span>
        </div>
      </div>
      ...
      <Card className="p-6 bg-[#0A162E] border-white/[0.08] space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {insights.fairnessMetrics.map((item) => (
            <div
              key={item.attribute}
              className="p-4 rounded-2xl bg-white/[0.02] border border-white/[0.04] space-y-3"
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  <span className="text-xs font-bold text-white block">{item.attribute}</span>
                  <span className="text-[11px] text-muted-foreground">{item.demographicGroup}</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs pt-1 border-t border-white/[0.03]">
                <div>
                ...
                <div>
                  ...
                  <span className="text-[9px] text-teal-300 block">Minimal Variance</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.04] text-[11px] text-muted-foreground flex items-start gap-2.5">
              ...
              <div key={feat.feature} className="space-y-1.5">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-white">{feat.displayName}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-mono font-bold text-teal-300 w-10 text-right">
                      {percentage}%
                    </span>
                  </div>
                </div>
                ...
                <div className="w-full h-2 rounded-full bg-white/[0.04] overflow-hidden">
                  <div
                    ...
                    className="h-full rounded-full bg-gradient-to-r from-teal-500 to-[#C4B5FD] transition-all duration-500"
                  />
                </div>
      ...
      <Card className="p-6 bg-[#0A162E] border-white/[0.08] space-y-4">
        <div className="flex items-center justify-between pb-2 border-b border-white/[0.06]">
          ...
          <span className="text-xs font-mono text-muted-foreground">4 Iterations Logged</span>
        </div>

        <div className="space-y-3 pt-1 text-xs">
          <div className="p-3.5 rounded-2xl bg-teal-500/5 border border-teal-500/20 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div className="space-y-0.5">
              <div className="flex items-center gap-2">
                <span className="font-mono font-bold text-teal-300">v2.4-volatility-prod</span>
          ...
          <div className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.04] flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div className="space-y-0.5">
              <div className="flex items-center gap-2">
                <span className="font-mono font-bold text-white">v2.3-telemetry-sync</span>
          ...
          <div className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.04] flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div className="space-y-0.5">
              <div className="flex items-center gap-2">
                <span className="font-mono font-bold text-white">v2.2-bbps-cadence</span>
                <Badge variant="outline" className="text-[9px] py-0 px-1.5">
                  Archived
                </Badge>
              </div>
